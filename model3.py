...
def load_images(frame_number, image_type, image_size=(64, 64)):
...
# Preprocess data
def preprocess_data(df, image_size=(64, 64)):
    albedo_images = []
    depth_images = []
    normal_images = []
    positions = []
    ...
    for _, row in df.iterrows():
        ...
        albedo_images.append(load_images(frame_number, 'albedo', image_size))
        depth_images.append(load_images(frame_number, 'depth', image_size))
        normal_images.append(load_images(frame_number, 'normal', image_size))
...
image_size = (64, 64)
albedo_images, depth_images, normal_images, positions, rotations = preprocess_data(df, image_size)
